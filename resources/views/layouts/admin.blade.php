...
<head>
    ...
    <title>{{ config('app.name', 'Flaster Group') }}</title>
    <link rel="shortcut icon" href="{{ asset('frontend/images/logo/icon.png') }}" type="image/svg" />
...
<body>
  ...
  <script src="a{{ asset('admin/js/plugins/moment.min.js') }}"></script>
  ...
  <script src="{{ asset('admin/js/material-dashboard.min1c51.js') }}" type="text/javascript"></script>
